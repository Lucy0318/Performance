...
class Main():
    ...
    def verifyStatus(self, url, timeout=3600):
        timeout = timeout
        for counter in range(1,timeout+1):
    ...
    def pollStats(self, statsDict=None, pollStatInterval=2, csvFile=False,
        ...
        waitForRunningStatusCounterExit = 40
		#waitForRunningStatusCounterExit = 20       //original value
        while True:
